...
const editAndPostRequestHandler = async (method, formValues, fbUserID, url) => {
...
export {
  postCarResponseHandler,
  editCarResponseHandler,
  editAndPostRequestHandler,
};
